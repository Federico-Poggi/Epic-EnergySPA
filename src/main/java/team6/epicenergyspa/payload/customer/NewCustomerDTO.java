...
public record NewCustomerDTO(@NotEmpty(message = "Company Name field can't be empty!") String companyName,
                             ...
                             @NotNull(message = "Entering date field can't be empty!") LocalDate enteringDate,
                             @NotNull(message = "Last contact field can't be empty!") LocalDate lastContactDate,
                             @NotNull(message = "Annual turnover field can't be empty!") LocalDate annualTurnover,
